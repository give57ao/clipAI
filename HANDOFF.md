...
- **현재 성능(GT 108건, 2026-07-14 밤)**: recall 67.6%(73/108),
  **precision 80.2%(73/91) — 원래 목표(80%) 최초 돌파**. 베이스라인 `r8_final`
...
- **미해결 GT 충돌 6건(사용자 확인 대기)**: 01-01-04 6:28/17:15, 02-43-33 8:21,
  23-58-38 1:18:37/1:22:00, 02-15-28 25:58 — 예전 검수에선 "진짜", 2026-07-14
  목록에선 누락. 확인 전까지 기존 GT 유지.
