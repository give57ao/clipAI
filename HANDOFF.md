...
## ★ HUD 올킬 파이프라인 (2026-07-14 R7 완료 — recall 67.3%, precision 68.8%→77.6%)
...
- **현재 성능(GT 98건)**: recall 67.3%(66/98), **precision 77.6%(66/85)**.
  `_tp_diff --compare-to r5_final`: 유지 64 | 획득 2 | **상실 0**. 베이스라인
  `r7_final`. 이번 세션 중 precision 개선 폭 최대(+8.8%p).
