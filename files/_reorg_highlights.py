...
# 주석의 K/D 흐름 = 사용자 클립 육안 판독 (2026-07-09 2차 검수)
FP_SET: set[tuple[str, int]] = {
    ...
    # ("2026-03-26 01-26-52", 49) — 사용자 재확인: 진짜 올킬 → GT 편입 (2026-07-09)
    ("2026-03-29 01-01-04", 46),   # 6/6→7/6→경계→7/7: 실제 1킬+사망, +3은 오독
    ("2026-03-29 01-01-04", 70),   # 6/3→경계→7/4: 실제 1킬+사망
    ("2026-04-08 00-36-50", 16),   # 6/6→7/6→경계→7/7: 실제 1킬+사망
    # ("2026-04-08 02-15-28", 69) — 사용자 재확인: 진짜 올킬 → GT 편입 (2026-07-09)
    ("2026-04-09 02-05-29", 39),   # 2/3→4/4: 실제 2킬+1데스, 3번째 킬은 팬텀
    ("2026-04-09 02-05-29", 161),  # 9/10→10/10: 실제 1킬
    ("2026-04-23 23-41-07", 6),    # 1/1→3/1: 실제 2킬
    # ("2026-04-28 00-07-24", 58) — 사용자 재확인: 진짜 올킬 → GT 편입 (2026-07-09)
    ("2026-04-29 01-14-15", 100),  # 4/5→6/5: 실제 2킬
    ("2026-05-12 00-23-40", 30),   # 진짜 올킬(GT 18:28)은 클립 시작 전에 이미 종료 — 다음 라운드로 오귀속. 클립 내 6/2→7/2 (1킬)
    # ("2026-05-18 01-54-57", 19) — 사용자 재확인: 진짜 올킬 → GT 편입 (2026-07-09)
    ("2026-05-19 01-36-22", 5),    # 7/1→7/2: 킬 0, 사망만
    ("2026-05-31 21-57-14", 139),  # 14/10: 사망 후 팀원 관전 화면 지속 — 관전 대상 K/D를 본인 것으로 오독
}
